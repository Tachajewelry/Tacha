...
window.onscroll = () => {
	...
	if(mq.matches) {
	// remove articel that have invisible
		$("section article:contains('invisible')").hide();
	...
	// else on desktop screen
		...
		$("section article:contains('invisible')").hide();
		//remove articel that have invisible
	$("section article:contains('invisible')").show().css("opacity", '0');
...
function showLoading() {
	document.body.style.overflowY = "visible";
	document.querySelector(".allBody").style.display = "block";
	document.querySelector(".allBody").style.overflowX = "hidden";
...
switch($(this).val()){
	...
	// change image when change selection
	
	switch($(this).val()){
			
	case "item1":
	$(this).css("background", "url('./images/products/stud%20Capio%20L.jpg')")
			$(this).css({
		...
		break;
	case "item2":
	$(this).css("background", "url('./images/products/stud%20capio%20M.jpg')")
			$(this).css({
			'background-repeat':'no-repeat',
			'background-size':'100% 300%',
			'background-position':'0px'
		...
		break;
			...
			case "item3":
	$(this).css("background", "url('./images/products/buckle1.jpg')")
			$(this).css({
			'background-repeat':'no-repeat',
			'background-size':'100% 300%',
			'background-position':'0px'
			...
			break;
			case "item4":
	$(this).css("background", "url('./images/products/Necklace1.jpg')")
			$(this).css({
			'background-repeat':'no-repeat',
			'background-size':'100% 300%',
			'background-position':'0px'
			...
			break;
			case "item5":
	$(this).css("background", "url('./images/products/Stud%20capio%20S.jpg')")
			$(this).css({
			'background-repeat':'no-repeat',
			'background-size':'100% 300%',
			'background-position':'0px'
			...
			break;
			case "item6":
	$(this).css("background", "url('./images/products/fiora%20wheel.jpg')")
			$(this).css({
			'background-repeat':'no-repeat',
			'background-size':'100% 300%',
			'background-position':'0px'
			...
			break;
			case "item7":
	$(this).css("background", "url('./images/products/seed%20wheel.jpg')")
			$(this).css({
			'background-repeat':'no-repeat',
			'background-size':'100% 300%',
			'background-position':'0px'
			...
			break;
			case "item8":
	$(this).css("background", "url('./images/products/lust%20wheel.jpg')")
			$(this).css({
			'background-repeat':'no-repeat',
			'background-size':'100% 300%',
			'background-position':'0px'
			...
			break;
			case "item9":
	$(this).css("background", "url('./images/products/rays.jpg')")
			$(this).css({
			'background-repeat':'no-repeat',
			'background-size':'100% 300%',
			'background-position':'0px'
